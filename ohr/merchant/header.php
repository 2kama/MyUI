  ...
  <div class="row">
        ...
        <div class="col-md-2 sideBar">
              ...
              <div class="list-group menuBit">
                ...
                <a href="orders" class="list-group-item list-group-item-action"><i class="fa fa-clipboard"></i> Orders</a>
                <a href="services" class="list-group-item list-group-item-action"><i class="fa fa-cloud-upload"></i> Service Management</a>
                <a href="issues" class="list-group-item list-group-item-action"><i class="fa fa-envelope"></i> Issues</a>
                <a href="profile" class="list-group-item list-group-item-action"><i class="fa fa-cog"></i> Profile</a>
              </div>
