				...
				<div class="col-md-4 offset-md-4 credential">
					...
					<div class="row" style="padding-top: 10px;">
						<div class="col-md-3 text-center">
							<a href="#"><i class="fa fa-linkedin" style="background: #0077b5;"></i></a>
						</div>

						<div class="col-md-3 text-center">
							<a href="#"><i class="fa fa-google" style="background: #db3236;"></i></a>
						</div>
					...
					<div class="row" style="margin-top: 30px;">
							...
							<div class="col-md-12">
							  <form action="">
								...
								<button class="btn col-md-4 offset-md-4">SIGN UP</button>
