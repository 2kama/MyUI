<?php include('header.php'); ?>
             ...
             <div class="container">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8" style="margin-top: 150px;">
                        ...
                        <h2>
                           Hire top notch professionals for your <br> projects
                        </h2>
                        ...
                        <p style="font-size: 17px;">
                          ...
                          <form class="hint-form">
                            ...
                            <div class="input-group mb-3">
                              <input type="text" class="form-control" placeholder="E.g. ‘ graphic designers ‘ or ‘ web designers’" aria-label="Recipient's username" aria-describedby="basic-addon2">
                              ...
                              <div class="input-group-append">
                                <button class="btn sadbtn" type="button">HIRE NOW</button>
                              </div>
                            </div>
      ...
      <div class="container-fluid">
        <div class="row tchala">
          ...
          <div class="col-md-2">
              <a href="#"><img src="img/law1.png" alt="">
              <div class="stan">BUSINESS <br>LAW</div></a>
          </div>

          <div class="col-md-2">
              <a href="#"><img src="img/law2.png" alt="">
              <div class="stan">CRIMINAL <br>LAW</div></a>
          </div>

          <div class="col-md-2">
              <a href="#"><img src="img/law3.png" alt="">
              <div class="stan">FAMILY <br>LAW</div></a>
          </div>

          <div class="col-md-2">
              <a href="#"><img src="img/law4.png" alt="">
              <div class="stan">PROPERTY <br>LAW</div></a>
          </div>


          <div class="col-md-2">
              <a href="#"><img src="img/law5.png" alt="">
              <div class="stan">INSOLVENCY</div></a>
          </div>

          <div class="col-md-2">
              <a href="#"><img src="img/law6.png" alt="">
      ...
      <div class="container" style="padding-top: 50px;padding-bottom: 50px;">
          ...
          <div class="row">
            <div class="col-md-4 offset-md-4">
               <h5 class="text-center">WHAT WE DO<br>&nbsp;</h5>
            </div>
              <div class="col-md-8">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane neg active" id="docu" role="tabpanel">
                        <h3>SELL LEGAL MATERIALS</h3>

                       <span>Legal Concierge offers you quick steps to purchase on-demand documents, law text-books and resources at an affordable fee!</span>
                    </div>
                    ...
                    <div class="tab-pane neg" id="advice" role="tabpanel">
                       ...
                       <span>You don’t have to drive a long distance to meet with an attorney! Select preferred lawyers within your location and get professional legal counsel on criminal law, family law, land law or immigration law at a negotiable fee.</span>
                    ...
                    <div class="tab-pane neg" id="rep" role="tabpanel">
                       ...
                       <span> Do you need help getting represented for criminal charges, prison cases, child protection matters, immigration problems.<br><br>

                              Or at risk of being alienated from your own property? Apply to be eligible to be represented by one of our lawyers.</span>
                    ...
                    <div class="tab-pane neg" id="counselling" role="tabpanel">
                       ...
                       <span>Take legal steps the right way! Our attorneys are a click away from guidance through contract creation, will writing and the creation of legal documents. </span>
  ...
  <div class="container-fluid" style="background: #ecedef; padding-top: 50px;padding-bottom: 20px;">
    
  
      <div class="container">
  
              <h5>BUY LEGAL DOCUMENTS</h5>
          ...
          <div class="row">
              <div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
                  ...
                  <h6 class="text-center" style="width: 100%;"><a href="" class="text-info">Read more ></a></h6>
            </div>
