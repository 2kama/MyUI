...
<div class="container-fluid profileHead">
		<div class="container" style="background: #fff;padding: 20px;">
			<div class="row">
				...
				<div class="col-md-6">
					<h5>Luxury Lawyer</h5>
					<p><b>Established:</b> 12 december 2004 &emsp; <i class="material-icons">room</i>Lagos, Nigeria.</p>
				...
				<div class="col-md-3">
					<div class="col-md-12 text-center profile-dix">
						<button class="btn myBtnColor2" data-toggle="modal" data-target="#deleteModal">DELETE USER</button>
					</div>
					<div class="col-md-12 text-center" style="margin-top: 20px;">
						<span class="badge badge-pill badge-danger" style="padding: 10px;color: #fff;cursor:pointer">Deactivate User</span>
					</div>
				</div>
			</div>
					...
					<div class="row tbcn">
						<div class="col-md-12">
							...
							<p style="margin-top: -20px;">
								...
								Drafting legal documents.<br>
								<ul>
									<li>Client counselling on business laws and copyright laws.</li>
									<li>Handles issues concerning patent acquisition, copyrights, trademarks or other intellectual property.</li>
